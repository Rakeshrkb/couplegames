    ...
    <section id="games-catalog" className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto scroll-mt-16">
      ...
      <div className="text-center max-w-3xl mx-auto mb-10">
        ...
        <p className="mt-3 text-base text-gray-600">
          30+ free couple games across 5 curated categories. Click any game to preview prompts & play instantly — no sign-up required.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-5">
          {filteredGames.map((game) => (
            <button
              ...
              className="group text-left relative flex flex-col justify-between bg-white rounded-2xl p-5 border-2 border-rose-100 hover:border-rose-300 hover:shadow-xl hover:shadow-rose-100/60 hover:-translate-y-1 transition-all duration-200"
            >
              <div>
                {/* Header info */}
